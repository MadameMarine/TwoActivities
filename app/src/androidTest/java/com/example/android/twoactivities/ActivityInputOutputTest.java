...
/*    This method will test whether the SecondActivity View element appear when
    ...
    public void textInputOutput(){
        onView(withId(R.id.editText_main)).perform(typeText("This is my Test after all this time"));
        onView(withId(R.id.button_main)).perform(click());
        onView(withId(R.id.text_message)).check(matches(withText("This is my Test after all this time")));
    }
}
